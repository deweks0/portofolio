            ...
            <div>
                <a href="#"
                    ...
                    <div class="text-white ls-lg h1 mb-0 ml-2">
                        {{ $slideOne->where('name', 'website_name')->first()->description }}</div>
                </a>
            </div>
            <div>
                <a href="{{ route('inquiries') }}" class="w-100 h-100 text-decoration-none d-flex bg-black px-4 py-4">
                    <div class="text-white small font-weight-light">
                        {{ $slideOne->where('name', 'website_info')->first()->description }}
                    </div>
                </a>
            </div>
        </div>
        <div class="small-box project">
            <a href="{{ route('project', 1) }}">
                ...
                <span class="position-absolute text-right small text-white ls-sm"
                    ...
                    {{ $slideOne->where('name', 'project_one')->first()->description }}
                </span>
            </a>
        </div>
        <div class="small-box project">
            <a href="{{ route('project', 2) }}">
                ...
                <span class="position-absolute text-right small text-white ls-sm"
                    style="right: 7%; top: 5%; width: 30%; text-shadow: 2px 2px 5px #000">
                    {{ $slideOne->where('name', 'project_two')->first()->description }}
                </span>
            </a>
        </div>
        <div class="big-box project">
            <a href="{{ route('project', 3) }}">
                ...
                <span class="position-absolute text-right small text-white ls-sm"
                    ...
                    {{ $slideOne->where('name', 'project_three')->first()->description }}
                </span>
            </a>
        </div>
        <div class="small-box project">
            <a href="{{ route('project', 4) }}">
                ...
                <span class="position-absolute text-right small text-white ls-sm"
                    style="right: 7%; top: 5%; width: 30%; text-shadow: 2px 2px 5px #000">
                    {{ $slideOne->where('name', 'project_four')->first()->description }}
                </span>
            </a>
        </div>
        <div class="small-box bg-white">
            <div class="h-100">
                <a href="{{ route('news') }}" style="white-space: pre-line"
                    ...
                    {{ $slideOne->where('name', 'news')->first()->description }}
                </a>
            </div>
        </div>
        <div class="small-box bg-white">
            <div class="h-100">
                <a href="{{ route('about') }}" style="white-space: pre-line"
                    class="d-flex text-dark text-decoration-none w-100 h-100 px-4 small">
                    {{ $slideOne->where('name', 'about')->first()->description }}
                </a>
            </div>
        </div>
        <div class="small-box project">
            <a href="{{ route('project', 5) }}">
                ...
                <span class="position-absolute text-right small text-white ls-sm"
                    style="right: 7%; top: 5%; width: 30%; text-shadow: 2px 2px 5px #000">
                    {{ $slideOne->where('name', 'project_five')->first()->description }}
                </span>
            </a>
        </div>
        <div class="small-box project">
            <a href="{{ route('project', 6) }}">
                ...
                <span class="position-absolute text-right small text-white ls-sm"
                    style="right: 7%; top: 5%; width: 30%; text-shadow: 2px 2px 5px #000">
                    {{ $slideOne->where('name', 'project_six')->first()->description }}
                </span>
            </a>
        </div>
        <div class="small-box project">
            <a href="{{ route('project', 7) }}">
                ...
                <span class="position-absolute text-right small text-white ls-sm"
                    style="right: 7%; top: 5%; width: 30%; text-shadow: 2px 2px 5px #000">
                    {{ $slideOne->where('name', 'project_seven')->first()->description }}
                </span>
            </a>
        </div>
        <div class="small-box project">
            <a href="{{ route('project', 8) }}">
                ...
                <span class="position-absolute text-right small text-white ls-sm"
                    style="right: 7%; top: 5%; width: 30%; text-shadow: 2px 2px 5px #000">
                    {{ $slideOne->where('name', 'project_eight')->first()->description }}
                </span>
            </a>
        </div>
        <div class="small-box project">
            <a href="{{ route('project', 9) }}">
                ...
                <span class="position-absolute text-right small text-white ls-sm"
                    style="right: 7%; top: 5%; width: 30%; text-shadow: 2px 2px 5px #000">
                    {{ $slideOne->where('name', 'project_nine')->first()->description }}
                </span>
            </a>
        </div>
    </section>
